    ...
    return !user ? <Redirect to='/'/> :
        (!match ? <div className='loading-animation-container'>
            ...
            <div className='loading-messages-container'>
                <span className="text">Hold tight while I find your cooking buddy!</span>
                ...
                <div className='content'>
                    <div>
                        ...
                        <div className='recipes-container'>
                            {!recipes ?
                                <p> I was unable to find a recipe suggestion based on your mutual ingredients; I still encourage you to use the chat (and your imagination) to plan something delicious!</p> :
                                <>
                    ...
                    <div className="chat">
                        <h2>Chat with each other and choose a recipe!</h2>
