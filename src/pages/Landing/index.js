    ...
    return <>
            ...
            <div className='landing-page-easy-steps-section'>
                <div className='landing-page-easy-step step-1'>
                    ...
                    <div className='easy-step-text-wrapper'>
                        ...
                        <div className='easy-step-text'>Start off by entering some basic information about yourself.</div>
                    </div>
                </div>
                ...
                <div className='landing-page-easy-step step-2'>
                    ...
                    <div className='easy-step-text-wrapper'>
                        ...
                        <div className='easy-step-text'>Choose a recipe based your combined inputs and begin cooking together!</div>
                    </div>
                </div>
            </div>
        ...
        <div className='landing-page-user-info-modal'>
            ...
            <div className='modal-window-title'>
                Enter your name and the ingredients that you possess or have access to
            </div>
